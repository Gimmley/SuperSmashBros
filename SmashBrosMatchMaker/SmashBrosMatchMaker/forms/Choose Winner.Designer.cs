namespace SmashBrosMatchMaker.forms
{
   partial class Choose_Winner
   {
      ...
      private void InitializeComponent()
      {
         ...
         this.cmbWinner.SelectedIndexChanged += new System.EventHandler(this.cmbPlayer1_SelectedIndexChanged);
         // 
         // lblPlayer1
         // 
         ...
         this.Load += new System.EventHandler(this.Choose_Winner_Load);
